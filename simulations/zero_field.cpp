...
void ZeroField::calculateResults(Simulation &sim) {
...
// DECORRELATIONS //
vector<double> ZeroField::autoCorrelations(vector<double>& mags, int t_eq)
{
...
double ZeroField::autoCovariance(vector<double>& mags, int t_start, int tau)
{
...
optional<int> ZeroField::decorrelationTime(vector<double>& autoCorrelation)
{
